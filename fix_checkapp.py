#!/usr/bin/env python3
"""
Script to fix the corrupted checkapp.py file by replacing the getTeams function
"""
...
# Read the current checkapp.py file
...
if start_line is not None and end_line is not None:
    ...
    with open('checkapp.py', 'w') as f:
        f.writelines(new_lines)
    
    print("✅ Successfully replaced the corrupted getTeams function!")
